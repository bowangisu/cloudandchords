...
import { getPostById, postCategories } from "../data/posts";
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          <p className="text-muted-foreground mb-4">{ui.blog.notFound[lang]}</p>
          <Link
            to="/blog"
            className="text-foreground/70 hover:text-foreground transition-colors text-[0.875rem]"
          >
            &larr; {ui.blog.backToBlog[lang]}
          </Link>
        </div>
      </div>
    );
    ...
    <div className="max-w-2xl mx-auto px-6 py-8 md:py-12">
      ...
      >
        ...
        <div className="flex items-center gap-5 text-[0.75rem] text-muted-foreground/40">
          ...
          >
            <Share2 size={12} />
            {copied ? ui.blog.copied[lang] : ui.song.share[lang]}
          </button>
        </div>
      </motion.header>
