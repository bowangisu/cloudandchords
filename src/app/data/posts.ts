...
I'd sit down at midnight and type something like: "Write a song about my children." The result was always generic. Formulaic. Hollow.

But when I typed: "Write a song about the specific loneliness of leaving your children, leaving home, leaving everything familiar, and going to a strange place — that sense of being completely alone" — something different happened. The AI had something real to work with. And so did I.
...
有一件事没人会提前告诉你：与AI协作创作时，输出的质量完全取决于提示词的质量。而提示词的质量，完全取决于你对自己的了解有多深。

午夜时分，我坐下来敲出这样一行字："写一首关于孩子的歌。"结果千篇一律——套话连篇，空洞无物。

但当我输入："写一首歌，关于那种特殊的孤独，离开了孩子，离开了家，离开了熟悉的一切，去了一个陌生的地方，那种孤独感"——一切都不同了。AI有了真实的素材可以加工，而我也终于面对了真实的自己。
...
When I use AI to write music, I'm not asking it to feel something on my behalf. I'm asking it to help me express something I already feel but lack the musical vocabulary and skill to articulate. The emotion is mine. The craft is collaborative. The result is something neither of us could produce alone.
...
I'll keep striving through my days, and keep using it to make music by night. But I'll never confuse the tool for the artist — and it will never replace the artist's desire to express. The tool doesn't dream. We do. And that's the whole difference.`,
      zh: `白天我构建AI，夜晚我用AI做音乐。这个工具非凡至极。但重要的是，对它是什么、不是什么，保持诚实。

AI不会做梦。它不会在凌晨两点辗转难眠、反复掂量今天做的决定对不对。它不会背负二十年前与父亲某次对话的重量。它不会在下雨天的晚上听出一段旋律，然后涌起一种自己都无法命名的情感。

这些不是有待解决的缺陷。它们是工具与创造者之间的分界线，而艺术恰恰栖居在那条线上。

当我用AI写音乐时，我不是在请它代替我去感受什么。我是在请它帮我表达那些我已然感受到、却缺乏音乐语言和自己乐技巧的局限去表述的东西。情感是我的，技艺是协作的，成果则是我们任何一方都无法独自完成的。
...
我会继续白天努力的生活，夜晚用它做音乐。但我永远不会把工具误认为艺术家也不会取代艺术家的表达的欲望。工具不会做梦。人类会。这就是全部的区别。`,
    },
  },
];
